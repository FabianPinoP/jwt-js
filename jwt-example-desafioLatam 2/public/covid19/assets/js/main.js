...
import { datos, grafico } from "./api_chile.js"; // ojo se exportan datos y grafico para que sean llamados desde otras funciones
...
(async () => {
  ...
  Nombres(data).forEach((element) => {
    table.innerHTML += `<tr>
      ...
      <td><button type="button" data-country=${element.location} class="btn btn-success">Ver detalles</button></td>
      </tr>`;
  });
...
document.getElementById("login").addEventListener("click", () => {
  ...
  $("#form").submit(async (e) => {
    ...
    if (JWT) {
      ...
      grafico(datos); // ojooooooooooooooooooooooooooooooooooooooo se puede cagar antes
